...
void getSumOfNumbersPolandFive(numbers* head)
{
	numbers* ptr = head;
	int sum = 0;
	while (ptr != nullptr)
	{
		if (ptr->parm > 0 && ptr->parm % 5 == 0)
		{
			sum += ptr->parm;
		}
		ptr = ptr->next;
	...
	{
		cout << "Положительынх элементов кратных 5 нет в списке\n";
	}
}
...
int main()
{
	...
	while (true)
	{
		...
		case 6:
			...
			break;
		case 7:
			getSumOfNumbersPolandFive(head);
			break;
		case 0:
			exit(0);
			break;
